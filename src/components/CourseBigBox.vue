      ...
      <div class="w-10/12">
        <div class="flex">
          <div class="flex-1 overflow-flex-wrap">
            ...
            <p>Platform: {{ course.platform_id }}</p>
        ...
        <div class="mt-4 space-y-1 text-sm text-gray-700 line-clamp-5">
          <p>
            A video course for every Laravel developer who wants to know how
            Laravel works under the hood to become more efficient while using
            it.
          </p>
        </div>
        <div class="mt-6">
